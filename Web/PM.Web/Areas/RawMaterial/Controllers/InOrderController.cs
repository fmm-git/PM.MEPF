...
namespace PM.Web.Areas.RawMaterial.Controllers
{
    ...
    public class InOrderController : BaseController
    {
        ...
        public ActionResult Img1(InOrderRequest request) 
        {
            var data = _inOrder.Img1(request);
            return Content(data.ToJson());
        }
        public ActionResult Img2(InOrderRequest request)
        {
            var data = _inOrder.Img2(request);
            return Content(data.ToJson());
        }
        #endregion

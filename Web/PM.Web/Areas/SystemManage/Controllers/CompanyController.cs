...
namespace PM.Web.Areas.SystemManage.Controllers
{
    public class CompanyController : BaseController
    {
        ...
        {
            ViewBag.CompanyCode = CreateCode.GetOrgId();
            return View();
        }
        [HttpGet]
        ...
        public ActionResult GetAllCompanyOrBySearch(string keyword)
        {
            ...
            foreach (TbCompanyOrParent item in data)
            {
        ...
        public ActionResult GetCompanyByProjectId(TbCompanyRequest request) 
        {
            var data = cit.GetCompanyByProjectId(request);
            return Content(data.ToJson());
        }
    }
}
